...
/*   47 : Deallocate */
jvmtiError jvmti_deallocate(jvmtiEnv *env, void* mem)
{
    return (*env)->Deallocate(env, (unsigned char*) mem);
}

/*   48 : Get Class Signature */
jvmtiError jvmti_get_class_signature(jvmtiEnv *env,jclass klass,char **signature_ptr,char **generic_ptr)
{
...
jvmtiError jvmti_get_loaded_classes(jvmtiEnv *env, jint *class_count_ptr, jclass **classes_ptr)
{
...
// {
//     return (*env)->GetLoadedClasses(env, class_count_ptr, classes_buf);
// }